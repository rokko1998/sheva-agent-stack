...
Agent infrastructure: shared Codex skills, lifecycle activation and the weekly updater for external Git sources. Knowledge policy and data are in the separate [`sheva-knowledge-stack`](/Users/sheva/Documents/Projects/sheva-knowledge-stack) repository.
